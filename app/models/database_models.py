...
class UserProfile(Base):
    ...
    date_of_birth = Column(String(50))  # Ou Date
    school_name = Column(String(255))
    school_level = Column(String(100))
    school_field = Column(String(255))
    school_region = Column(String(100))
    orientation_goal = Column(String(255))
    interests = Column(ARRAY(String))
    university = Column(String(255))
    study_level = Column(String(100))
    study_domain = Column(String(255))
    study_year = Column(String(100))
    is_alternance = Column(Boolean, default=False)
    internship_count = Column(Integer)
    seeking_type = Column(String(100))
    key_skills = Column(ARRAY(String))
    informal_activity = Column(String(255))
    informal_sector = Column(String(255))
    spoken_languages = Column(ARRAY(String))
    school_level_reached = Column(String(100))
    informal_goal = Column(String(255))
    practical_skills = Column(Text)
